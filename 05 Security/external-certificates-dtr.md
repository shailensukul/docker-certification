# Security > Describe ​​process ​​to ​​use ​​external ​​certificates ​​with ​​UCP ​​and ​​DTR - DTR
...
You can configure DTR to use your own TLS certificates, so that it is automatically trusted by your users' browser and client tools. As of v2.7, you can also [enable user authentication via client certificates](https://docs.docker.com/ee/enable-client-certificate-authentication/) provided by your organization's public key infrastructure (PKI).

Replace the server certificates[](https://docs.docker.com/ee/dtr/admin/configure/use-your-own-tls-certificates/#replace-the-server-certificates)
------------------------------------------------------------------------------------------------------------------------------------------------
...
### Web interface[](https://docs.docker.com/ee/dtr/admin/configure/use-your-own-tls-certificates/#web-interface)
...
![](https://docs.docker.com/ee/dtr/images/use-your-certificates-1.png)
...
### Command line interface[](https://docs.docker.com/ee/dtr/admin/configure/use-your-own-tls-certificates/#command-line-interface)

See [docker/dtr install](https://docs.docker.com/reference/dtr/2.7/cli/install/) and [docker/dtr reconfigure](https://docs.docker.com/reference/dtr/2.7/cli/reconfigure/) for TLS certificate options and usage.